...
function base_url($string = ""){
	if($string == ""){
		$url = $_SERVER['SERVER_NAME'] == 'localhost' ? 'http://localhost/SISPUS/' : 'http://'.$_SERVER['SERVER_NAME']."/SISPUS/";	
	} else {
		$url = $_SERVER['SERVER_NAME'] == 'localhost' ? 'http://localhost/SISPUS/'.$string : 'http://'.$_SERVER['SERVER_NAME']."/SISPUS/".$string;
	}
